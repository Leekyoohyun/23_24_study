...
class neuralNetwork:
    ...
    def __init__(self,wih,who):
        ...
        #self 함수로 class의 모든 장소에서 함수와 변수를 사용가능, pow승을 의미하는 함수임.
    ...
    def train(self,inputs_list,targets_list):
        ...
        #인풋 리스트를 행렬로 만들어준 뒤, 전치하여 계산하는 단계. dot이 행렬계산. ones는 1로 이루어진 행렬 구성.
        #이로 만들어진 히든 인풋을 self.sig에 넣어 히든 아웃풋 취득. 비슷한 과정을 반복
